# Privacy Policy for AISRE

## Introduction

Welcome to AISRE, the **Mini Program AI Entrepreneurship Program Code Generator** designed to help you build custom mini programs without coding skills. At AISRE, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using AISRE:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use AISRE, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access AISRE, such as device type, operating system, and browser type.
...
## Mini Program Platform Data

When you create and deploy mini programs using our service, we may process data related to the platforms where your mini programs are published (such as WeChat, Alipay, and others). This processing is governed by the terms and privacy policies of those platforms, and we encourage you to review those policies as well.
...
**Website**: [ai.linux008.com](https://ai.linux008.com)
**Email**: [support@linux008.com](mailto:support@linux008.com)

By using AISRE, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
